...
\begin{document}
	...
	\section{Introduction}
		...
		\begin{frame}
			...
			\begin{tabular}{cc}
				\includegraphics[width=0.5\linewidth]{Images/Introduction/Word}&\includegraphics[width=0.5\linewidth]{Images/Introduction/Latex}\\
				Word & \LaTeX
			\end{tabular}
		...
		\begin{frame}
			...
			\begin{tabular}{ccc}
				\includegraphics[width=0.45\linewidth]{Images/Introduction/fichier_tex} & &
				\includegraphics[width=0.45\linewidth]{Images/Introduction/fichier_PDF}\\
	...
	\section{Mettre en forme le texte}
		...
		\begin{frame}
			...
			\begin{center}
			\includegraphics[scale=0.8]{Images/Structure/maketitle}
			\end{center}
		...
		\begin{frame}
				...
				\includegraphics[width=0.5\linewidth]{Images/Structure/structure}
...
\begin{minipage}[c][0cm]{5cm}
	\begin{center}
		\includegraphics[scale=0.8]{Images/Structure/ecrivons}
	\end{center}
\end{minipage}			
...
\includegraphics[width=7cm]{Images/Complements/code}
	...
	\centering 
	\includegraphics[width=10cm]{Images/Mathematiques/environnement1}
	...
	\begin{frame}[fragile=singleslide]
		...
		\centering 
		\includegraphics[width=12cm]{Images/Mathematiques/environnement2}
	...
	\centering 
	\includegraphics[width=11cm]{Images/Mathematiques/environnement3}
...
\begin{minipage}{3cm}
	\vspace*{1cm}
	\includegraphics[width=3cm]{Images/Mathematiques/lettresgrecques}\vspace*{1.6cm}
	\includegraphics[width=3cm]{Images/Mathematiques/glyphes}
\end{minipage}
...
\end{minipage}\hfill
\begin{minipage}[c][0cm]{5cm}
	\includegraphics[width=3cm]{Images/Mathematiques/matrix1}
\end{minipage}
...
\end{minipage}\hfill
\begin{minipage}[c][0cm]{5cm}
	\includegraphics[width=3cm]{Images/Mathematiques/matrix2}
\end{minipage}
...
\end{minipage}\hfill
\begin{minipage}[c][0cm]{5cm}
	\includegraphics[width=3cm]{Images/Mathematiques/matrix3}
\end{minipage}
...
\end{minipage}\hfill
\begin{minipage}[c][0cm]{5cm}
	\includegraphics[width=3cm]{Images/Mathematiques/matrix4}
\end{minipage}
...
\end{minipage}\hfill
\begin{minipage}[c][0cm]{5cm}
	\includegraphics[width=5cm]{Images/Mathematiques/systeme}
\end{minipage}	
