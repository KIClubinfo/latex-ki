...
\newpage
	...
	Sur certains appareils, tu peux te connecter à Eduroam comme si c'était un réseau normal, en spécifiant ton identifiant et ton mot de passe (et potentiellement en désactivant la vérification du certificat). 
    ...
    {\begin{enumerate}
      ...
      \begin{figure}[h!]
        \centering
        \fbox{\includegraphics[width=0.4\textwidth]{page28_1}}
        \qquad
        \fbox{\includegraphics[width=0.4\textwidth]{page28_2}}
      \end{figure}
    \end{enumerate}}
